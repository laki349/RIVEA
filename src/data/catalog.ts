...
export const concerns: Concern[] = [
  {
    ...
    tips: [
      ...
      { bold: "나이아신·비타C", rest: "저녁엔 미백 성분으로 톤 케어" },
  ...
  },
  {
    ...
    tips: [
      { bold: "콜라겐·펩타이드", rest: "탄력 성분을 저녁 루틴에" },
      { bold: "EMS 리프팅", rest: "아침 3분, 디바이스로 리프팅" },
      { bold: "목·턱선", rest: "얼굴만큼 목 라인도 함께" },
    ],
  },
  {
    slug: "dry",
    ...
    tips: [
      { bold: "세라마이드", rest: "장벽 성분으로 수분 잠그기" },
      { bold: "저자극 클렌징", rest: "세안부터 순하게 바꾸기" },
      { bold: "수분 마스크", rest: "주 2회 집중 보습" },
    ],
  },
  {
    slug: "sun",
    ...
    tips: [
      { bold: "SPF50+", rest: "외출 전 마지막 단계는 선케어" },
      { bold: "덧바르기", rest: "쿠션·스틱으로 낮에 보충" },
      { bold: "톤업 겸용", rest: "기미 커버와 차단을 한 번에" },
    ],
  },
  {
    slug: "pore",
    ...
    tips: [
      { bold: "BHA", rest: "주 1~2회 각질·피지 정리" },
      { bold: "수분", rest: "속건조가 모공을 더 키워요" },
      { bold: "탄력 케어", rest: "모공 관리의 반은 탄력" },
    ],
  },
  {
    slug: "scalp-hair",
    ...
    tips: [
      { bold: "두피 스케일링", rest: "주 1회 노폐물 정리" },
      { bold: "볼륨 앰플", rest: "모근 강화 성분 매일" },
      { bold: "LED 두피 디바이스", rest: "홈케어로 모근 자극" },
    ],
  },
  {
    slug: "inner",
    ...
    tips: [
      { bold: "저분자 콜라겐", rest: "흡수율 높은 제형으로" },
      { bold: "유산균", rest: "장이 편해야 피부가 맑아요" },
      { bold: "꾸준함", rest: "이너뷰티는 최소 8주" },
    ],
  },
];
