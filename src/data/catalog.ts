...
export type Brand = {
  ...
  tagline: string;
  /**
   * ⚠️ `since`·`rating`·`freeShippingOver`·`shippingFee`를 지웠다 (2026-08-25).
   * 라로슈포제·헤라 같은 **실존 기업의 입점 연도와 배송 정책을 지어낸 값**이었다.
   * 우리가 실제로 아는 건 공식몰 주소뿐이다.
   */
...
export const brands: Brand[] = [
  ...
  // 화면에 띄우고 있었다.
  { slug: "medicube", name: "메디큐브", tagline: "에이피알 홈뷰티 디바이스", isReal: true, officialUrl: "https://themedicube.co.kr/age-r/main.html" },
  { slug: "lgpral", name: "LG 프라엘", tagline: "LG 뷰티 디바이스", isReal: true, officialUrl: "https://lgpralofficial.co.kr/" },
  { slug: "glasslike", name: "글래스라이크", tagline: "기기 전용 스킨케어", isReal: true, officialUrl: "https://www.lgcaremall.com/product/list/10665" },
  { slug: "cellreturn", name: "셀리턴", tagline: "LED·PEMF 웰니스 디바이스", isReal: true, officialUrl: "https://cellreturnmall.co.kr/" },
  { slug: "dualsonic", name: "듀얼소닉", tagline: "홈 초음파 리프팅", isReal: true, officialUrl: "https://dualsonic.com/" },
  { slug: "anua", name: "아누아", tagline: "성분 함량 공개 스킨케어", isReal: true, officialUrl: "https://anua.kr" },
  { slug: "paulaschoice", name: "폴라초이스", tagline: "성분 중심 더마 스킨케어", isReal: true, officialUrl: "https://www.paulaschoice.co.kr" },
  { slug: "laroche", name: "라로슈포제", tagline: "민감 피부 더마", isReal: true, officialUrl: "https://www.larocheposay.co.kr" },
  { slug: "roundlab", name: "라운드랩", tagline: "자작나무 수분 라인", isReal: true, officialUrl: "https://roundlab.co.kr" },
  { slug: "drforhair", name: "닥터포헤어", tagline: "두피·탈모 케어 전문", isReal: true, officialUrl: "https://www.drforhair.co.kr" },
  { slug: "mediheal", name: "메디힐", tagline: "데일리 시트 마스크", isReal: true, officialUrl: "https://medihealshop.com" },
  ...
  { slug: "hera", name: "헤라", tagline: "아모레퍼시픽 베이스 메이크업", isReal: true },
  { slug: "clio", name: "클리오", tagline: "커버력 중심 베이스", isReal: true },
  { slug: "estra", name: "에스트라", tagline: "아모레퍼시픽 더마", isReal: true },
  { slug: "numbuzin", name: "넘버즈인", tagline: "번호로 나눈 성분 라인", isReal: true, officialUrl: "https://numbuzin.com" },
  { slug: "torriden", name: "토리든", tagline: "저분자 히알루론산 수분 라인", isReal: true, officialUrl: "https://torriden.com" },
  { slug: "nutree", name: "뉴트리", tagline: "에버콜라겐 이너뷰티", isReal: true, officialUrl: "https://newtreemall.co.kr" },
  { slug: "iope", name: "아이오페", tagline: "아모레퍼시픽 베이스 메이크업", isReal: true, officialUrl: "https://www.iope.com" },
];
...
export type Product = {
  ...
  /**
   * ⚠️ `rating`·`reviewCount`·`likes`·`cohortViews`를 **타입에서 지웠다** (2026-08-25).
   *
   * 화면에서 내리는 것만으로는 부족했다 — `prescribe.ts`가 `p.rating`을 점수에 더하고
   * 있었고, 카테고리 「인기순」이 `likes`로 정렬하고 있었다. **화면에 안 보이는데
   * 창작 숫자가 계속 결정을 하고 있었다.** 필드를 없애면 실수로 쓸 수가 없다.
   *
   * 실제 리뷰가 쌓이면 그때 우리 집계에서 파생한다. 그 전까지는 없는 게 맞다.
   */
...
concerns: ["dry"],
  ...
  // ── 2026-08-25 5차 수집분: 토리든 ──
  // 한 브랜드로 세안부터 크림까지 한 줄이 다 채워지는 라인을 처음 넣었다.
  // 배송이 한 번에 묶이는 건 40대+에게 실제로 작동하는 이유다 — 네 군데서 시켜
  // 네 번 받는 것보다 한 번에 오는 쪽이 8주를 채울 확률이 높다.
  {
    ...
    listPrice: null,
    badges: ["베스트"],
    keyIngredient: "저분자 히알루론산 (함량 미공개)",
    volume: "300ml",
    usage:
      "아침·저녁 세안 후 첫 단계에. 300ml라 화장솜에 넉넉히 적셔 써도 부담이 적어요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=2269",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "35ml",
    usage:
      "아침·저녁 토너 다음에 2~3방울. 가벼운 제형이라 크림 전 단계입니다.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=462",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "100ml",
    usage:
      "마지막 단계에 얹어 앞에서 채운 수분을 덮습니다. 젤 제형이라 여름에도 밀리지 않아요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=2277",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "200ml",
    usage:
      "마른 얼굴에 굴려 녹인 뒤 물로 유화시켜 헹굽니다. 선크림을 바른 날 저녁의 첫 자리예요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=253",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "150ml",
    usage:
      "물에 적신 손에 덜어 거품을 낸 뒤 얼굴을 감싸듯 씻어냅니다.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=2276",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "150ml",
    usage:
      "물기 없는 얼굴에 펴 바르고 굴린 뒤 헹굽니다. 산과 같은 날 겹치지 마세요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=467",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "27ml × 10매",
    usage:
      "토너 다음에 15~20분. 주 2회면 충분해요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=114",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "120ml",
    usage:
      "낮에 당길 때 20cm 떨어뜨려 뿌립니다. 마르기 전에 다음 단계를 얹어야 오히려 안 당겨요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=449",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
...
concerns: ["dry"],
    ...
    listPrice: null,
    badges: [],
    keyIngredient: "저분자 콜라겐 (함량 미공개)",
    volume: "60ml",
    usage:
      "저녁 마지막 단계에. 콜라겐은 바르는 쪽과 먹는 쪽이 다른 자리예요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=186",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
...
concerns: ["dry"],
    ...
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=324",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    listPrice: null,
    badges: ["NEW"],
    keyIngredient: "비타민C 유도체 (함량 미공개)",
    volume: "50ml",
    usage:
      "저녁 마지막 단계에. 비타민C는 빛에 약해 개봉 후엔 서늘한 데 두세요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=2294",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "70매",
    usage:
      "세안 후 결을 따라 닦아냅니다. 산·레티놀과 같은 날 겹치지 않는 쪽이 편해요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=257",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  // ── 2026-08-25 6차 수집분: 비어 있던 자리 세 개 ──
  // 눈가(0종)·목(0종)·기미커버(1종). 앞의 둘은 자리 자체가 없어서 넣을 수도 없었고
  // (regimen.ts에 `eye`·`neck` 신설), 기미커버는 40대+ 고민 조사에서 계속 나오는데
  // 쿠션 하나로 버티고 있었다. 공식몰이 열리지 않아 다나와 최저가로 수집했다.
  {
    id: "c-ahc-eyecream",
    image: "product-p4.jpg",
    brand: "ahc",
    name: "시즌10 레볼루션 리얼 아이크림 포페이스 30ml",
    category: "skincare",
    ...
    volume: "30ml",
    usage:
      "세럼 다음, 크림 전에 눈가를 따라 두드려 폅니다. 30ml라 얼굴까지 쓰는 사람이 많지만, 표정선이 남는 자리에 먼저 쓰는 게 순서예요.",
    source: {
      sourceUrl: "https://prod.danawa.com/info/?pcode=16179416",
      pricedAt: "2026-08-25",
      priceNote: "다나와 최저가",
    },
  },
  {
    ...
    listPrice: null,
    badges: ["NEW"],
    keyIngredient: "PDRN · 콜라겐 (함량 미공개)",
    volume: "본품 1개",
    usage:
      "얼굴 마무리 뒤 목과 턱선에 아래에서 위로 폅니다. 얼굴만 관리하고 목을 빼면 경계가 그대로 보여요 — 주름 고민에서 자주 빠지는 자리입니다.",
    source: {
      sourceUrl: "https://themedicube.co.kr/",
      buyUrl: "https://themedicube.co.kr/product/detail.html?product_no=2871&cate_no=466&display_group=1",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://themedicube.co.kr/",
    },
  ...
  {
    id: "c-hera-black-cushion",
    actives: [{ key: "sunscreen" }],
    image: "product-p10.jpg",
    brand: "hera",
    name: "블랙 쿠션 15g (본품+리필) SPF34/PA++",
    category: "cover-makeup",
    concerns: ["pigment", "sun"],
    tags: ["쿠션", "커버", "리필 포함"],
    price: 35120,
    ...
    volume: "15g × 2 (본품+리필)",
    usage:
      "아침 자외선 차단 다음에 얇게 두드려 올립니다. SPF34/PA++ 표시가 있지만 선크림을 대신하지는 않아요 — 덧바르는 자리입니다.",
    source: {
      sourceUrl: "https://prod.danawa.com/info/?pcode=13741565",
      pricedAt: "2026-08-25",
      priceNote: "다나와 최저가",
    },
  },
  {
    ...
    volume: "6g",
    usage:
      "쿠션 다음, 가리고 싶은 자리에만 얹고 경계를 두드려 풉니다. 얼굴 전체를 두껍게 바르는 것보다 이쪽이 덜 티나요.",
    source: {
      sourceUrl: "https://prod.danawa.com/info/?pcode=19999478",
      pricedAt: "2026-08-25",
      priceNote: "다나와 최저가",
    },
  },
  {
    id: "c-estra-atobarrier-cream",
    actives: [{ key: "ceramide" }],
    image: "product-p4.jpg",
    brand: "estra",
    ...
    listPrice: null,
    badges: ["베스트"],
    keyIngredient: "세라마이드 (함량 미공개)",
    volume: "80ml",
    usage: "마지막 단계에 얹습니다. 세안 직후 몇 분 안에 바르는 쪽이 덜 날아가요.",
    source: {
      sourceUrl: "https://prod.danawa.com/info/?pcode=6521915",
      pricedAt: "2026-08-25",
      priceNote: "다나와 최저가",
    },
  },
  // ── 토리든 2차: 같은 라인 안에서도 자리를 나눠 담는다 ──
  {
    ...
    volume: "200ml",
    usage:
      "아침·저녁 세안 후 첫 단계에. 손으로 두드려 흡수시킵니다.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=2293",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "30ml",
    usage:
      "신경 쓰이는 자리에만 얹습니다. 얼굴 전체용이 아니라 점찍듯 쓰는 제형이에요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=2295",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    listPrice: null,
    badges: [],
    keyIngredient: "센텔라아시아티카 (함량 미공개)",
    volume: "80ml",
    usage:
      "마지막 단계에 얹습니다. 산·레티놀을 쓴 다음 날 자리를 지키는 쪽이에요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=162",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "250ml",
    usage:
      "세안 후 첫 단계에. 각질을 정돈하는 쪽이라 산과 같은 날 겹치지 마세요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=230",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=156",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=169",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "200ml",
    usage:
      "마른 얼굴에 펴 바른 뒤 물로 헹굽니다. 오일이 무겁게 느껴지는 사람의 자리예요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=363",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    volume: "11ml",
    usage:
      "입술과 입술 주변에 수시로. 건조가 심한 계절엔 자기 전 한 번 더 바르세요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=362",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  // ── 2026-08-25 7차: 눈가 자리에 선택지를 만든다 ──
  // 자리를 만들어놨는데 앉힐 게 하나뿐이면 자리를 만든 값이 없다.
  // 공식몰을 확인 못 한 브랜드라 다나와 최저가로 수집했다.
  {
    id: "c-ahc-eyecream-s13",
    image: "product-p4.jpg",
    brand: "ahc",
    name: "시즌13 프리미어 앰플 아이크림 40ml",
    category: "skincare",
    concerns: ["wrinkle", "dry"],
    tags: ["아이크림", "눈가", "40ml"],
    price: 6490,
    ...
    keyIngredient: "브랜드 미공개",
    volume: "40ml",
    usage: "세럼 다음, 크림 전에 눈가를 따라 두드려 폅니다.",
    source: {
      sourceUrl: "https://prod.danawa.com/info/?pcode=76374593",
      pricedAt: "2026-08-25",
      priceNote: "다나와 최저가",
    },
  },
  {
    id: "c-eucerin-eyecream",
    image: "product-p4.jpg",
    brand: "eucerin",
    name: "이븐래디언스 다크서클 아이크림 15ml",
    category: "skincare",
    concerns: ["pigment", "wrinkle"],
    tags: ["아이크림", "눈가", "15ml"],
    price: 14590,
    listPrice: null,
    badges: [],
    ...
    volume: "15ml",
    usage:
      "세럼 다음, 크림 전에 눈 밑을 따라 두드립니다. 눈 밑 어두움은 색소만이 아니라 그림자도 섞여 있어 바르는 것만으로 다 되지는 않아요.",
    source: {
      sourceUrl: "https://prod.danawa.com/info/?pcode=17534618",
      pricedAt: "2026-08-25",
      priceNote: "다나와 최저가",
    },
  },
  {
    ...
    usage: "세럼 다음, 크림 전에 눈가를 따라 두드려 폅니다.",
    source: {
      sourceUrl: "https://prod.danawa.com/info/?pcode=119125596",
      pricedAt: "2026-08-25",
      priceNote: "다나와 최저가",
    },
  },
  {
    ...
    keyIngredient: "저분자 히알루론산 (함량 미공개)",
    volume: "400ml",
    usage: "화장솜에 적셔 닦아낸 뒤 물세안으로 마무리합니다.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=263",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  {
    ...
    keyIngredient: "저분자 히알루론산 (함량 미공개)",
    volume: "120ml",
    usage: "아침·저녁 토너 다음에. 120ml라 목까지 이어 발라도 부담이 적어요.",
    source: {
      sourceUrl: "https://torriden.com/goods/goods_list.php?cateCd=001",
      buyUrl: "https://torriden.com/goods/goods_view.php?goodsNo=463",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://torriden.com",
    },
  },
  // ── 2026-08-25 8차 수집분: 넘버즈인 ──
  //
  // ⚠️ 이번 회차부터 **`actives`를 채울 수 있는 제품을 우선 고른다.**
  //    QA(`.gstack/qa-reports/qa-report-rivea-logic-2026-08-25.md` ISSUE-001·003)에서
  //    화장품 81종 중 61종에 `actives`가 없고, 그 61종은 (1) 병용 판정에 잡히지 않고
  //    (2) 고민 배정이 근거표가 아니라 손 태그로 결정된다는 게 확인됐다.
  //    제품을 더 넣을수록 그 면적이 커지므로, 최소한 **새로 넣는 것은 늘리지 않는다.**
  //
  // 같은 이유로 이번에 **일부러 건너뛴 것**: 글루타치온C 흔적 앰플 · NMN PDRN 토너 ·
  // 로즈 PDRN 콜라겐 세럼. 셋 다 `ActiveKey`에 없는 성분이라 넣으면 「색소/주름 때문에
  // 여기 있다」는 이유 라벨만 붙고 근거는 비는, ISSUE-001과 똑같은 모양이 된다.
  {
    id: "c-numbuzin-panto-serum",
    actives: [{ key: "panthenol" }],
    image: "product-p3.jpg",
    brand: "numbuzin",
    name: "1번 판토텐산 액티브업 수딩세럼 50ml",
    category: "skincare",
    concerns: ["dry"],
    tags: ["세럼", "판테놀", "진정"],
    price: 22500,
    listPrice: 30000,
    badges: ["베스트"],
    keyIngredient: "판테놀 · 판토테닉애씨드 (함량 미공개)",
    volume: "50ml",
    usage:
      "아침·저녁 토너 다음에. 판테놀은 수분을 끌어와 붙잡는 쪽이라 크림 전 단계가 자리예요.",
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/1%EB%B2%88-%ED%8C%90%ED%86%A0%ED%85%90%EC%82%B0-%EC%95%A1%ED%8B%B0%EB%B8%8C%EC%97%85-%EC%88%98%EB%94%A9%EC%84%B8%EB%9F%BC-50ml/28/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  },
  {
    id: "c-numbuzin-panto-cream",
    actives: [{ key: "panthenol" }],
    image: "product-p4.jpg",
    brand: "numbuzin",
    name: "1번 판토텐산 액티브 수딩크림 80ml",
    category: "skincare",
    concerns: ["dry"],
    tags: ["크림", "판테놀", "진정"],
    price: 21000,
    ...
    volume: "80ml",
    usage:
      "마지막 단계에 얹어 앞에서 채운 수분을 덮습니다. 산·레티놀을 쓴 다음 날에도 무난한 쪽이에요.",
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/1%EB%B2%88-%ED%8C%90%ED%86%A0%ED%85%90%EC%82%B0-%EC%95%A1%ED%8B%B0%EB%B8%8C-%EC%88%98%EB%94%A9%ED%81%AC%EB%A6%BC-80ml/26/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  },
  {
    ...
    listPrice: 20000,
    badges: [],
    keyIngredient: "판테놀 · 히알루론산 (함량 미공개)",
    volume: "5매",
    usage:
      "토너 다음에 15~20분. 주 2회면 충분해요.",
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/1%EB%B2%88-%ED%9E%88%EC%95%8C%EB%A3%A8%EB%A1%9C%EB%8B%89-%ED%8C%90%ED%86%A0%ED%85%90%EC%82%B0-%ED%81%B4%EB%A6%AC%EC%96%B4-%EC%88%98%EB%94%A9-%EA%B1%B0%EC%A6%88%ED%8C%A9-5%EB%A7%A4/113/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  },
  {
    ...
    image: "product-p5.jpg",
    brand: "numbuzin",
    name: "1번 청초 진정맑은 물막선크림 SPF50+ PA++++ 50ml",
    category: "suncare",
    concerns: ["sun"],
    tags: ["자외선", "SPF50+", "가벼운 제형"],
    price: 18200,
    listPrice: 26000,
    badges: ["빠른배송"],
    keyIngredient: "자외선 차단 성분 (SPF50+ PA++++)",
    volume: "50ml",
    usage:
      "아침 마지막 단계에 충분한 양을 폅니다. 이 단계가 노화를 늦춘다는 걸 장기 시험으로 보인 유일한 항목이에요.",
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/1%EB%B2%88-%EC%B2%AD%EC%B4%88-%EC%A7%84%EC%A0%95%EB%A7%91%EC%9D%80-%EB%AC%BC%EB%A7%89%EC%84%A0%ED%81%AC%EB%A6%BC-spf50-pa-50ml/25/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  ...
  {
    id: "c-numbuzin-tone-sun",
    actives: [{ key: "sunscreen" }],
    image: "product-p5.jpg",
    brand: "numbuzin",
    name: "3번 도자기결 톤업베이지 선크림 SPF50+ PA++++ 50ml",
    category: "suncare",
    concerns: ["sun"],
    tags: ["자외선", "톤업", "SPF50+"],
    price: 23400,
    ...
    volume: "50ml",
    usage:
      "아침 마지막 단계에. 톤업 제형이라 이것만으로 끝내는 날에도 차단이 빠지지 않아요.",
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/3%EB%B2%88-%EB%8F%84%EC%9E%90%EA%B8%B0%EA%B2%B0-%ED%86%A4%EC%97%85%EB%B2%A0%EC%9D%B4%EC%A7%80-%EC%84%A0%ED%81%AC%EB%A6%BC-spf50-pa-50ml-%EB%B8%94%EB%9F%AC%EA%B8%80%EB%A1%9C%EC%9A%B0/181/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  ...
  {
    id: "c-numbuzin-pha-pack",
    actives: [{ key: "aha-bha" }],
    image: "product-p3.jpg",
    brand: "numbuzin",
    name: "3번 매끈결 PHA 프렙 버블팩 90ml",
    category: "cleansing",
    concerns: ["pore"],
    tags: ["각질", "PHA", "버블팩"],
    price: 24300,
    ...
    volume: "90ml",
    usage:
      "세안 후 펴 바르고 거품이 올라오면 헹굽니다. PHA도 산이라 레티놀·BHA와 같은 날 겹치지 마세요.",
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/3%EB%B2%88-%EB%A7%A4%EB%81%88%EA%B2%B0-pha-%ED%94%84%EB%A0%99-%EB%B2%84%EB%B8%94%ED%8C%A9-90ml/202/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  ...
  {
    id: "c-numbuzin-cleansing-oil",
    image: "product-p3.jpg",
    brand: "numbuzin",
    name: "1번 말끔 순삭 클렌징오일 200ml",
    category: "cleansing",
    concerns: ["pore"],
    tags: ["클렌징", "오일", "이중세안"],
    price: 18200,
    ...
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/1%EB%B2%88-%EB%A7%90%EB%81%94-%EC%88%9C%EC%82%AD-%ED%81%B4%EB%A0%8C%EC%A7%95%EC%98%A4%EC%9D%BC-200ml/20/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  ...
  {
    id: "c-numbuzin-cleansing-foam",
    image: "product-p3.jpg",
    brand: "numbuzin",
    name: "2번 딥클린 생크림 클렌징폼 120ml",
    category: "cleansing",
    concerns: ["dry"],
    tags: ["클렌징폼", "저자극", "약산성"],
    price: 9800,
    ...
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/2%EB%B2%88-%EB%94%A5%ED%81%B4%EB%A6%B0-%EC%83%9D%ED%81%AC%EB%A6%BC-%ED%81%B4%EB%A0%8C%EC%A7%95%ED%8F%BC-120ml/31/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  ...
  {
    id: "c-numbuzin-boost-toner",
    image: "product-p3.jpg",
    brand: "numbuzin",
    name: "3번 보들보들 퍼스트결 부스팅 토너 200ml",
    category: "skincare",
    concerns: ["dry", "pore"],
    tags: ["토너", "결 정돈", "200ml"],
    price: 21600,
    ...
    source: {
      sourceUrl: "https://numbuzin.com/product/list.html?cate_no=24",
      buyUrl: "https://numbuzin.com/product/3%EB%B2%88-%EB%B3%B4%EB%93%A4%EB%B3%B4%EB%93%A4-%ED%8D%BC%EC%8A%A4%ED%8A%B8%EA%B2%B0-%EB%B6%80%EC%8A%A4%ED%8C%85-%ED%86%A0%EB%84%88-200ml/183/",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://numbuzin.com",
    },
  },
  // ── 2026-08-25 9차(마무리): 얇았던 카테고리를 채운다 ──
  // 기미커버 3 · 두피 4 · 이너 4가 나머지(스킨케어 45·클렌징 20)에 비해 얇았다.
  // MVP를 공개하는 시점이라 「고민을 골랐는데 놓을 게 없다」가 나오면 안 된다.
  {
    id: "c-drforhair-phyto-serum",
    image: "product-p7.jpg",
    brand: "drforhair",
    name: "피토테라피 하이드로 스칼프 세럼 60ml",
    category: "scalp-hair",
    concerns: ["scalp-hair", "dry"],
    tags: ["두피", "세럼", "저자극"],
    price: 21900,
    listPrice: 28000,
    badges: [],
    ...
    volume: "60ml",
    usage:
      "말린 두피에 가르마를 따라 떨어뜨리고 손끝으로 눌러 폅니다. 두피가 당기거나 가려운 쪽에 맞춘 라인이에요.",
    source: {
      sourceUrl: "https://www.drforhair.co.kr/product/list.html?cate_no=1",
      buyUrl: "https://www.drforhair.co.kr/product/detail.html?product_no=1317",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://www.drforhair.co.kr",
    },
  ...
  {
    id: "c-drforhair-phyto-shampoo",
    image: "product-p7.jpg",
    brand: "drforhair",
    name: "피토테라피 두피케어 샴푸 500ml",
    category: "scalp-hair",
    concerns: ["scalp-hair"],
    tags: ["두피", "샴푸", "저자극"],
    price: 17900,
    ...
    volume: "500ml",
    usage:
      "두피에 문질러 거품을 내고 헹굽니다. 탈모완화 라인이 자극되면 이쪽이 순한 편이에요.",
    source: {
      sourceUrl: "https://www.drforhair.co.kr/product/list.html?cate_no=1",
      buyUrl: "https://www.drforhair.co.kr/product/detail.html?product_no=969",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://www.drforhair.co.kr",
    },
  ...
  {
    id: "c-drforhair-treatment",
    image: "product-p7.jpg",
    brand: "drforhair",
    name: "피토테라피 헤어트리트먼트 500ml",
    category: "scalp-hair",
    concerns: ["scalp-hair", "dry"],
    tags: ["트리트먼트", "모발", "대용량"],
    price: 19800,
    ...
    volume: "500ml",
    usage:
      "샴푸 후 모발에만 발라 2~3분 두고 헹굽니다. 두피에는 바르지 않아요.",
    source: {
      sourceUrl: "https://www.drforhair.co.kr/product/list.html?cate_no=1",
      buyUrl: "https://www.drforhair.co.kr/product/detail.html?product_no=975",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://www.drforhair.co.kr",
    },
  ...
  {
    id: "c-drforhair-exfoliator",
    image: "product-p7.jpg",
    brand: "drforhair",
    name: "폴리젠 씨크닝 씨솔트 스칼프 엑스폴리에이터 250g",
    category: "scalp-hair",
    concerns: ["scalp-hair"],
    tags: ["두피", "각질", "스크럽"],
    price: 19900,
    ...
    volume: "250g",
    usage:
      "주 1~2회, 감기 전 젖은 두피에 문지른 뒤 샴푸합니다. 매일 쓰는 자리가 아니에요.",
    source: {
      sourceUrl: "https://www.drforhair.co.kr/product/list.html?cate_no=1",
      buyUrl: "https://www.drforhair.co.kr/product/detail.html?product_no=963",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가",
      officialUrl: "https://www.drforhair.co.kr",
    },
  ...
  {
    id: "c-nutree-time-biotin-cell",
    actives: [{ key: "collagen" }],
    image: "product-p8.jpg",
    brand: "nutree",
    name: "에버콜라겐 타임비오틴 셀 50일분",
    category: "inner",
    concerns: ["inner", "scalp-hair"],
    tags: ["이너뷰티", "콜라겐", "50일분"],
    price: 47400,
    listPrice: 79000,
    badges: [],
    keyIngredient: "저분자콜라겐펩타이드 30mg/g + 비오틴 1,200㎍ + 아연·셀렌",
    volume: "3g × 50포",
    usage:
      "1일 1회, 1포를 그대로 섭취합니다. 50포라 8주 판정에 맞는 분량이에요.",
    source: {
      sourceUrl: "https://newtreemall.co.kr/product/detail.html?product_no=340&cate_no=1&display_group=5",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가 (소비자가 79,000원 · 시점 할인가는 별도)",
      officialUrl: "https://newtreemall.co.kr",
    },
  },
  {
    id: "c-nutree-gyno-quick",
    image: "product-p8.jpg",
    brand: "nutree",
    name: "지노마스터 퀵 질유산균 1개월분",
    category: "inner",
    concerns: ["inner"],
    tags: ["이너뷰티", "유산균", "30포"],
    price: 31500,
    listPrice: 89000,
    badges: [],
    keyIngredient: "리스펙타 프로바이오틱스 50억 CFU + 락토페린 54mg",
    volume: "1.5g × 30포",
    usage:
      "1일 1회, 1포를 그대로 또는 물과 함께. 표시 기능성은 「질내 유익균 증식 및 유해균 억제」로 피부와는 다른 자리예요.",
    source: {
      sourceUrl: "https://newtreemall.co.kr/product/detail.html?product_no=649&cate_no=1&display_group=7",
      pricedAt: "2026-08-25",
      priceNote: "공식몰 판매가 (소비자가 89,000원 · 시점 할인가는 별도)",
      officialUrl: "https://newtreemall.co.kr",
    },
  },
  {
    ...
    image: "product-p10.jpg",
    brand: "clio",
    name: "킬커버 메쉬글로우 쿠션 15g (본품+리필) SPF50+/PA++++",
    category: "cover-makeup",
    concerns: ["pigment", "sun"],
    tags: ["쿠션", "커버", "리필 포함"],
    price: 17590,
    ...
    volume: "15g × 2 (본품+리필)",
    usage:
      "아침 자외선 차단 다음에 얇게 두드려 올립니다. SPF 표시가 있어도 선크림을 대신하지는 않아요 — 덧바르는 자리입니다.",
    source: {
      sourceUrl: "https://prod.danawa.com/info/?pcode=19103537",
      pricedAt: "2026-08-25",
      priceNote: "다나와 최저가",
    },
  },
  {
    id: "c-iope-cushion-main",
    actives: [{ key: "sunscreen" }],
    image: "product-p10.jpg",
    brand: "iope",
    name: "에어쿠션 5.5세대 커버 15g (본품) SPF50+/PA+++",
    category: "cover-makeup",
    concerns: ["pigment", "sun"],
    tags: ["쿠션", "커버", "본품"],
    price: 21550,
    ...
    volume: "15g",
    usage:
      "아침 마지막 단계에 얇게 두드려 올립니다. 리필만 따로 파는 라인이라 다음부터는 리필로 사시면 돼요.",
    source: {
...
/**
 * ⚠️ **세트가는 단품 합계와 같다. 할인을 표시하지 않는다** (2026-08-25).
 *
 * 전에는 r5~r10에 10~15% 세트 할인이 붙어 있었다. 그런데 **우리는 결제를 받지 않는다** —
 * 구매는 브랜드 공식몰에서 일어나고, 우리가 13,800원을 깎아줄 방법이 없다.
 * 못 지키는 약속을 화면에 띄우면 사용자가 그 가격에 사려다 안 되는 순간이 첫 배신이 된다.
 *
 * 세트의 값은 **가격이 아니라 조합과 순서**다. `why`가 그걸 설명한다.
 */
